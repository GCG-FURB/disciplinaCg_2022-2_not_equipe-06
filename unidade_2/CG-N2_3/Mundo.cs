...
namespace gcgcg
{
  class Mundo : GameWindow
  {
    ...
    protected override void OnLoad(EventArgs e)
    {
      ...
      Ponto4D cima = new Ponto4D(0, 100);
      DesenharCirculo(cima, 100, new Cor(0, 0, 0, 255), 5);

      Ponto4D esquerdaInf = new Ponto4D(-100, -100);
      DesenharCirculo(esquerdaInf, 100, new Cor(0, 0, 0, 255), 5);

      Ponto4D direitaInf = new Ponto4D(100, -100);
      DesenharCirculo(direitaInf, 100, new Cor(0, 0, 0, 255), 5);

      DesenharReta(cima, esquerdaInf, new Cor(0, 255, 255, 255), 5);
      DesenharReta(esquerdaInf, direitaInf, new Cor(0, 255, 255, 255), 5);
      DesenharReta(direitaInf, cima, new Cor(0, 255, 255, 255), 5);
