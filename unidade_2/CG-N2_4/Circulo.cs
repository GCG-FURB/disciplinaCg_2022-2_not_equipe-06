...
namespace gcgcg
{
    internal class Circulo : ObjetoGeometria
    {
        ...
        public Circulo(char rotulo, Objeto paiRef, Ponto4D pontoCentral, int raioCirculo, int qtdPontos = 72, PrimitiveType primitivo = PrimitiveType.Points) : base(rotulo, paiRef)
        {
